    ...
    <div className={`${className} `}>
      <Link to={link} className='group duration-2000'>
        <Flex className="gap-x-2">
          <button className="text-buttonTextColor px-4 py-1 md:px-6 md:py-3 lg:px-6 lg:py-3 rounded-full border-2 border-theme bg-theme active:bg-transparent hover:bg-opacity-[0.5]">{text}</button>
          <button class="bg-theme text-buttonTextColor font-bold w-[35px] h-[35px] md:w-[50px] md:h-[50px]  lg:w-[50px] lg:h-[50px] rounded-full  flex items-center justify-center relative  overflow-hidden rotate-[42deg] ">
