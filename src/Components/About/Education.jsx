...
const Education = () => {
  return (
    <div>
        ...
        <Flex className=" grid lg:grid-cols-4 justify-between gap-1">
        ...
        <Flex className=" grid lg:grid-cols-4 justify-between gap-1 mt-2">
        <div className="innerEducation lg:col-span-2">
            <MinTitle text ="(Diploma in Computer Science) Shamoly Ideal Polytechnic Institute"/>
